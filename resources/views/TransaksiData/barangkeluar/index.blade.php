                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="editBarangModalLabel">
                                                                            Edit Barang Keluar</h5>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                    </div>
                                                                    <form
                                                                        action="{{ route('barangkeluar.update', ['barangkeluar' => $barangkeluar->id]) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" class="form-control"
                                                                                    id="tgl" name="tgl" value="{{ $barangkeluar->tgl }}" required>
                                                                            </div>
                                                                            <div class="form-group mt-3">
                                                                                <label for="jumlah">Jumlah Keluar</label>
                                                                                <input type="number" class="form-control"
                                                                                    id="jumlah" name="jumlah" value="{{ $barangkeluar->jumlah }}" required>
                                                                            </div>
                                                                            <div class="form-group mt-3">
                                                                                <label for="penerima">Penerima</label>
                                                                                <input type="text" class="form-control"
                                                                                    id="penerima" name="penerima" value="{{ $barangkeluar->penerima }}" required>
                                                                            </div>
                                                                            <div class="form-group mt-3">
                                                                                <label for="keterangan">Keterangan</label>
                                                                                <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ $barangkeluar->keterangan }}</textarea>
                                                                            </div>
                                                                        </div>
